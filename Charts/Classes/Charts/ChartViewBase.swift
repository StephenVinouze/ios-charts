...
public protocol ChartViewDelegate
{
    ...
    optional func chartMinScaled(chartView: ChartViewBase, gestureAxis: BarLineChartViewBase.GestureScaleAxis)
    
    optional func chartMaxScaled(chartView: ChartViewBase, gestureAxis: BarLineChartViewBase.GestureScaleAxis)
